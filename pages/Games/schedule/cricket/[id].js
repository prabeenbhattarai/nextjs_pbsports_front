...
export default function SchedulePage({ schedule,liveSchedule}) {
        ...
        <Container>
          {showVideo ? (
            ...
            <VideoFrameWrapper>
              <VideoFrame
                src={schedule.url}
                allowfullscreen="allowfullscreen" allowtransparency="true" frameborder="0"
              ></VideoFrame>
            </VideoFrameWrapper>
            <Center>
            <TitleContainer>
...
export async function getServerSideProps(context) {
  ...
  const liveSchedule = await Schedule.find({}, null, {sort: {'_id':-1}, limit:10});
  return {
    props: {
