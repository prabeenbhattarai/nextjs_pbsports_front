...
export default function IccTestBox({ _id, title, description, url, time, images, showScheduledTimeTag }) {
  ...
  const link = '/Games/schedule/cricket/ICC_World_Test_Champions/' + _id;
