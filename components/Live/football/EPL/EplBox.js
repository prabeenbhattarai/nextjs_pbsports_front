...
export default function EplBox({ _id, title, description, url, time, images, showScheduledTimeTag }) {
  ...
  const link = '/Games/schedule/football/English_Premier_League/' + _id;
