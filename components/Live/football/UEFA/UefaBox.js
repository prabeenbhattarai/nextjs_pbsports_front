...
export default function UefaBox({ _id, title, description, url, time, images, showScheduledTimeTag }) {
  ...
  const link = '/Games/schedule/football/UEFA_Champions_League/' + _id;
